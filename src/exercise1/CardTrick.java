...
public class CardTrick {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < hand.length; i++) {
            hand[i] = new Card();
            hand[i].setValue(1 + rand.nextInt(13));            
    ...
    private static void printInfo() {
        ...
        System.out.println("My name is Carey, but you can call me Carey");
        System.out.println();
        
        System.out.println("My career ambitions:");
        System.out.println("-- Maintain my 4.0 GPA");
	...
	System.out.println();	
        ...
        System.out.println("-- Home Renovations");
